...
import com.jyu.hsqcloudgallerybackend.mapper.SpaceUserMapper;
...
/**
 * 空间用户服务实现类，继承自ServiceImpl并实现SpaceUserService接口
 * 提供空间用户相关的业务逻辑实现
 */
@Service
public class SpaceUserServiceImpl extends ServiceImpl<SpaceUserMapper, SpaceUser>
    ...
    @Resource
    @Lazy
    private SpaceService spaceService; // 空间服务，用于处理空间相关操作，使用@Lazy注解延迟加载

    /**
     * 添加空间用户
     * @param spaceUserAddRequest 添加空间用户的请求对象
     * @return 新增空间用户的ID
     */
    @Override
    ...
    /**
     * 获取空间用户的查询条件构造器
     * @param spaceUserQueryRequest 空间用户查询请求对象
     * @return 查询条件构造器
     */
    @Override
